...
class HtmlUtils {
  ...
  public String createHtmlHeader(String title) {
    ...
    htmlHeader = "<HTML><HEAD><TITLE> " + title + " </TITLE></HEAD><BODY><img src=\"images/fb_housie.jpg\" alt=\"Mountain View\" style=\"width: 304px; height: 228px\"><a href=\"HousieController?action=generate\">Generate New</a>          <a href=\"#\" onclick=\"javascript:window.print();\" >Print</a>";
    return htmlHeader;
  }
  ...
  public String getTableContents(String align, Vector values,
      int elementCounter,int width) throws IOException {
    ...
    for (int i = 0; i < vsize; i++) {
      ...
      Cells.write("<TD style=\"width:"+width+"\" align=" + align + "> " + value + " </TD> \n");
    }
